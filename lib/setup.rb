requiure_relative 'csv_reader.rb'              # Provide access to CSVReader class methods
requiure_relative 'area.rb'                    #Provide access to Area class methods
...
class Setup
  ...
  def initialize
    ...
    csv.read do |item|                         # Iterate through each item in the Hash
      @areas << Area.new                       # Shovel data into array
    end
